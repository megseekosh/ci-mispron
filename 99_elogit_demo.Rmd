...
I am not sure how to convery it visually but here are the proportions converted into elogits with points sized by model weights.
...
Let's set up a simple example with an unweighted versus and weighted model.
Model comparison favors the weighted model.
...
What this autocorrelation does to the average residual here is bonkers. Maybe we
should not use it?
